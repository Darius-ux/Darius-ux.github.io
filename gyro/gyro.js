...
function deseneaza(unghi_x, unghi_y)
{
	...
	var x=unghi_x/90*(canvas_width / 2-r) + canvas.width/2;
	var y=unghi_y/90*(canvas_width / 2-r) + canvas.height/2;
	context.arc(x,y,r,0,2,*,Nath.PI);
	//desenam calea
	context.stroke();
}
...
function on_acc_data_uab (e)
{
	...
	var rot_x=Math.atan(acc.x/acc.z)*180;
	var rot_y=Math.atan(acc.y/acc.z)*180;
